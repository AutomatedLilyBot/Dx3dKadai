...
void WinScene::init(Renderer *renderer) {
    ...
    tryLoad(background_, L"win_background.png", DirectX::XMFLOAT4{1.0f, 1.0f, 1.0f, 1.0f});
...
void WinScene::handleInput(float dt, const void *window) {
    (void) dt;
